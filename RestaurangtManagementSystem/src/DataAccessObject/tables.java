    ...
    public tables() {
        try {
           // Drop existing database if it exists
            ...
            String productTable = "create table product(id int AUTO_INCREMENT primary key, name varchar(200), category varchar(200), price DECIMAL(10, 2), UNIQUE(name, category), Category_ID int, FOREIGN KEY (Category_ID) REFERENCES category(id))";            
            ...
            String Bill_ProductTable = "CREATE TABLE Bill_Product ( BillID INT, ProductID INT, FOREIGN KEY (BillID) REFERENCES bill(id) ON DELETE NO ACTION, FOREIGN KEY (ProductID) REFERENCES product(id) ON DELETE NO ACTION)";
